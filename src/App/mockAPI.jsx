const mockAPI = {
    ...
    getUserById () {
      return Promise.resolve({
        "data":{"id":18,
                ...
                "score":0.3,
                "keyData":{"calorieCount":2500,"proteinCount":90,"carbohydrateCount":150,
                "lipidCount":120}}
      })
    },
    getUserActivityById (){
      return Promise.resolve({
        "data":{"userId":18,
                "sessions":[{"day":"2020-07-01","kilogram":70,"calories":240},
  ...
  12 :{
    ...
    getUserActivityById (){
      return Promise.resolve({
        "data":{"userId":12,
                "sessions":[{"day":"2020-07-01","kilogram":80,"calories":240},
